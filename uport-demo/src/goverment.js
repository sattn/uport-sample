...
const credentials = new Credentials({
    ...
    did: 'did:ethr:0x4ce46a3c9196516288290a6aed34e22feb6331a8',
    privateKey: '29b9a54b373b59985327a9c34e1ec07a31c657831a241fecff16e8fad95bb8c2'
})
          ...
          <main className="container">
            <div className="pure-g">
              <div className="pure-u-1-1">
                <h1>Goverment Page</h1>
                <p>オフライン上で本人確認を行ったあとに提示されるページです。</p>
                <h2>本人証明書の発行</h2>
...
app.post('/callback', (req, res) => {
    ...
    credentials.authenticateDisclosureResponse(jwt).then(creds => {
      ...
      credentials.createVerification({
        ...
        claim: {'Identity' : {'Last Seen' : `${new Date()}`, 'First Name': 'Tarou', 'Familly Name': 'Yamada', 'Birthday': '2000/12/11'}}
